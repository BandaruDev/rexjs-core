        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    resolver = function (file, base) { return new Promise(function (resolves, reject) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, new Promise(function (resolves, reject) {
                            loader.fs.readFile(result, function (err, content) {
                                ...
                                var outputPath = loader_utils_1.interpolateName({ resourcePath: result }, filename, { content: content });
